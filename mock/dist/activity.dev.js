    ...
    todayResult: {
      ...
      conditions: [{
        ...
        options: [{
          ruleId: "ru_1",
          optionId: "123",
          optionName: "狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮狗粮",
          optionStock: 1,
          optionImg: "http://yun.duiba.com.cn/polaris/丝倍亮小型犬幼年年期全价犬粮7.5kg.c27e9ef4b4d418e8a90faa76798e20cb4f18a490.jpg",
          prizeId: "123",
          prizeType: 1,
...
var turnTableDraw = {
  ...
  data: {
    ...
    options: [{
      ...
      optionName: "肯德基炸鸡圈",
      optionImg: "//yun.duiba.com.cn/aurora/assets/d8b6eaa9b0292dc53e5cbc15a8ff89e023e2d8aa.png"
    }]
  }
};
var turnTableQuery = {
...
var answerQuery = {
  ...
  data: {
    ...
    answers: ["坡道障碍滑雪", "是德国第三个圣诞节还是对酒当歌手机号", "打飞机估计会受到各方就会打给谁发回国倒计时的"],
...
module.exports = {
  listExchangeLimit: listExchangeLimit,
  doExchange: doExchange,
  getMyPrize: getMyPrize,
  getRank: getRank,
  turnTableDraw: turnTableDraw,
  turnTableQuery: turnTableQuery,
