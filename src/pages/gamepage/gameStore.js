...
const gameStore = makeAutoObservable(mix({
    ...
    addPropGuide21(){
        const propGuide21 = FYGE.Sprite.fromUrl("//yun.duiba.com.cn/aurora/assets/5cd95e8f0c35efefc6e051df324867089b0e456f.png")
        propGuide21.x =  3740 // 29212 6655
        propGuide21.y =  890
        this.bgCon.addChildAt(propGuide21,1)

        const propGuideNice21 = FYGE.Sprite.fromUrl("//yun.duiba.com.cn/aurora/assets/940f611ebd4024cdb1698f8919873660293adb0f.png")
        propGuideNice21.x =  5020
        propGuideNice21.y =  1290
        this.bgCon.addChildAt(propGuideNice21,1)
    },
    ...
    addPropGuide81(){
        const propGuide81 = FYGE.Sprite.fromUrl("//yun.duiba.com.cn/aurora/assets/538c007f534b184d79d4e18594615f1df3a2c6b1.png")
        propGuide81.x =  20605 // 29212 6655
        propGuide81.y =  4570
        this.bgCon.addChildAt(propGuide81,1)

        const propGuideNice81 = FYGE.Sprite.fromUrl("//yun.duiba.com.cn/aurora/assets/940f611ebd4024cdb1698f8919873660293adb0f.png")
        propGuideNice81.x =  21905
        propGuideNice81.y =  4920
        this.bgCon.addChildAt(propGuideNice81,1)
    },
    ...
    stockArea(i,Shapestock) {
        ...
        Shapestock.lineTo(i * 100, this.lineInfo[i] + 1200)
        Shapestock.lineTo((i - 1) * 100, this.lineInfo[i] + 1200)
        Shapestock.endFill()
        // return Shapestock;
    },
    pasueGame(){
